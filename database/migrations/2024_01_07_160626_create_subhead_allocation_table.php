...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('subhead_allocation', function (Blueprint $table) {
            ...
            $table->unsignedInteger('allocation_id')->references('allocation_id')->on('transactions')->nullable();
            ...
            $table->unsignedInteger('year_id')->references('year_id')->on('budget_year')->nullable();
