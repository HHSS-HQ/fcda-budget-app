...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card mb-4">
      <h5 class="card-header">Project Edit Form</h5>
      <!-- Account -->
      ...
      <hr class="my-0">
      <div class="card-body">
        <form id="formAccountSettings" action="" action="{{ route('project.update', [$item->id]) }}" method="PUT" >
          @csrf
          ...
          <div class="row">
            <div class="mb-3 col-md-6">
              ...
              <input class="form-control {{ $errors->has('project_title') ? 'error' : '' }}" type="text" id="project_title" name="project_title" autofocus value="{{$item->project_title}}" placeholder="Project Title"/>
            <!-- Error -->
        ...
        @endif
            ...
            <div class="mb-3 col-md-6">
              ...
              <input class="form-control {{ $errors->has('project_location') ? 'error' : '' }}" type="text" name="project_location" id="project_location" value="{{$item->project_location}}" placeholder="Project Location"/>
                        <!-- Error -->
