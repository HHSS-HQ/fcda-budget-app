        ...
        <form id="formAccountSettings" action="" action="{{ route('budget.store') }}" method="POST">
          ...
          <div class="row">
            <div class="mb-3 col-md-6">
              ...
              <input class="form-control {{ $errors->has('budget_year') ? 'error' : '' }}" type="number"
                placeholder="YYYY" min="2022" max="2040" id="budget_year" name="budget_year" autofocus
            ...
            <div class="mb-3 col-md-6">
              ...
              <input class="form-control {{ $errors->has('appropriated_amount') ? 'error' : '' }}" type="number"
