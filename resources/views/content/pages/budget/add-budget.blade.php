      ...
      <div class="card-body">
        <form id="formAccountSettings" action="" action="{{ route('budget.store') }}" method="POST" >
          ...
          <div class="row">
            <div class="mb-3 col-md-6">
              ...
              <input class="form-control {{ $errors->has('budget_year') ? 'error' : '' }}"  type="number" placeholder="YYYY" min="2022" max="2040" id="budget_year" name="budget_year" autofocus placeholder="Budget Year"/>
              {{-- <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span> --}}
              <!-- Error -->
        @if ($errors->has('budget_year'))
        <div class="error">
            {{ $errors->first('budget_year') }}
        </div>
        @endif
            </div>
        ...
        @endif
            ...
            <div class="mb-3 col-md-6">
              ...
              <input class="form-control {{ $errors->has('code') ? 'error' : '' }}" type="text" id="code" name="code" autofocus placeholder="Code"/>
              {{-- <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span> --}}
              <!-- Error -->
        @if ($errors->has('code'))
        <div class="error">
